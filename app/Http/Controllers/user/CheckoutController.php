...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request){
        ...
        $wards=Wards::where('xaid',Session::get('fee_xaid'))->first();
        ...
        $shipping->customer_name = Session::get('name');
        $shipping->customer_email = Session::get('email');
        $shipping->customer_address = Session::get('address');
        $shipping->customer_phone = Session::get('phone');
        $shipping->customer_note = Session::get('note');
        $shipping->save();
