                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    <th>Hình ảnh : </th>
                                    <td><img src="{{asset('public\images/'. $slider->image)}}" width="500px" height="300px"/></td>
                                </tr>
                                <tr>
...
{{--        <th>Highlight</th>--}}
        ...
        @foreach($sliders as $slider)
            <tr>
                <td width="10%"><img src="{{asset('public/images/'. $slider->image)}}" width="300px" height="100px"/></td>
