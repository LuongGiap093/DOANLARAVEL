...
@section('content')
    ...
    <main>
        <section class="container">
            ...
            <h1 class="main-ttl"><span>Tất cả sản phẩm</span></h1>
            <!-- Catalog Sidebar - start -->
            <div class="section-sb">

                <!-- Catalog Categories - start -->
                <div class="section-sb-current">
                    <h3><a href="catalog-list.html">Danh mục sản phẩm <span id="section-sb-toggle" class="section-sb-toggle"><span
                    ...
                    <ul class="section-sb-list" id="section-sb-list">
                        ...
                        <li class="categ-1 has_child">
                            <a href="catalog-list.html">
                                <span class="categ-1-label">{{$cate->category_name}}</span>
                            ...
                            <ul>
                                ...
                                <li class="categ-2">
                                    <a href="catalog-list.html">
                                        <span class="categ-2-label">{{$brand->brand_name}}</span>
                                    </a>
                                </li>
                                    @endif
                                @endforeach
                ...
                <div class="section-filter">
                    ...
                    <div class="section-filter-cont">
                        <div class="section-filter-price">
                            <div class="range-slider section-filter-price" data-min="1000000" data-max="30000000" data-from="1000000"
                                 data-to="30000000" data-prefix="" data-grid="false"></div>
                        </div>
                        ...
                        <div class="section-filter-item">
                            ...
                            <div class="section-filter-fields">
                                ...
                                <p class="section-filter-field">
                                    ...
                                    <label class="section-filter-checkbox" for="section-filter-checkbox5-5">Boot
                                        Cut</label>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="section-filter-buttons">
                            <input class="btn btn-themes" id="set_filter" name="set_filter" value="Apply filter"
                                   type="button">
            ...
            <div class="section-cont">
                ...
                <div class="section-top">
                    ...
                    <ul class="section-mode">
                        <li class="section-mode-gallery active"><a title="View mode: Gallery"
                                                                   href="catalog-gallery.html"></a></li>
                    ...
                    <div class="section-sortby">
                        ...
                        <ul name="sort" id="sort">
                            <li>
                                <a href="#">Mức độ phổ biến</a>
                            </li>
                            <li>
                                <a href="{{Request::url()}}?sort_by=tang_dan">Giá thấp đến cao</a>
                            </li>
                            <li>
                                <a href="{{Request::url()}}?sort_by=giam_dan">Giá cao đến thấp</a>
                            </li>
                            <li>
                                <a href="{{Request::url()}}?sort_by=kytu_az">Ký tự: từ A <i class="fa fa-angle-right"></i> Z</a>
                            </li>
                            <li>
                                <a href="{{Request::url()}}?sort_by=kytu_za">Ký tự: từ Z <i class="fa fa-angle-right"></i> A</a>
                            </li>
                            <li>
                                <a href="{{Request::url()}}?sort_by=none">Sắp xếp mặc định</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="prod-items section-items">
                    ...
                    <div class="prod-i">
                        <div class="prod-i-top">
                            <a href="{{route('shopping.viewProduct', $product->id)}}" class="prod-i-img"><!-- NO SPACE --><img
                                    src="{{asset('public/images/'. $product->image)}}" alt="Adipisci aperiam commodi"><!-- NO SPACE -->
                            </a>
                            <p class="prod-i-info">
                            ...
                            <a href="javascripts:" onclick="AddCart({{$product->id}})"
                               data-text="Add To Cart" class="prod-i-buy">Add to cart</a>
                            ...
                            <div class="prod-sticker">
                                ...
                                @if(($product->discount*100)/$product->price >0 && ($product->discount*100)/$product->price <20)
                                    <br>
                                    <p class="prod-sticker-3">-{{ number_format(($product->discount*100)/$product->price) }}%</p><p class="prod-sticker-4 countdown" data-date="29 Jan 2022, 0:30:00"></p>
                        ...
                        <h3>
                            <a href="{{route('shopping.viewProduct', $product->id)}}">{{$product->name}}</a>
                        </h3>
                        ...
                        <div class="prod-i-skuwrapcolor">
                            <ul class="prod-i-skucolor">
                                <li class="bx_active"><img src="{!! asset('public/user/assets/img/color/red.jpg') !!}" alt="Red"></li>
                ...
                <!-- Pagination - start -->
                <ul class="pagi" style="text-align: center;">
                    {!! $products->links() !!}
                </ul>
