        ...
        <div class="container">
            <div class="row">
                <div class="companyinfo">
                    <a href="index.html">
                        <img src="{!! asset('public\user\assets\img/logo-b.png') !!}" alt="AllStore - MultiConcept eCommerce Responsive HTML5 Template">
                        Nhà cung cấp thiết bị di động hàng đầu Việt Nam!
                    </a>
                </div>
                <div class="f-block-list">
                    ...
                    <div class="f-block-wrap">
                        <div class="f-block">
                            ...
                            <p class="f-info-ttl">Hỏi câu hỏi</p>
                            <p>Chúng tôi sẽ gọi lại trong vòng 10 phút.</p>
                        </div>
                    </div>
                    <div class="f-block-wrap">
                        <div class="f-block">
                    ...
                    <div class="f-block-wrap">
                        <div class="f-block">
                            ...
                            <p>Huỳnh Thúc Kháng, Bến Nghé, Quận 1.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="f-delivery">
                    <img src="{!! asset('public\user\assets\img/map.png') !!}" alt="">
                    <h4>Giao hàng miễn phí tại tp.HCM</h4>
                    <p>Chúng tôi sẽ giao hàng trong vòng 1 giờ</p>
                </div>
            </div>
        </div>
    </div>
