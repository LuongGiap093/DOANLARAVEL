        ...
        <div class="item" style="background-image: url({!!asset('images/'. $slider->image) !!});">
            <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="big-text fadeInDown-1"> {{$slider->slider_big_title}}  <span class="highlight">{{($slider->highlight_text)}}</span> </div>
                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>{!! $slider->slider_description !!}</span> </div>
                    <div class="button-holder fadeInDown-3"> <a href="#" class="btn-lg btn btn-uppercase btn-primary shop-now-button">{{$slider->slider_title_button}}</a> </div>
                </div>
                <!-- /.caption -->
            </div>
            <!-- /.container-fluid -->
