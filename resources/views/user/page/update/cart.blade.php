                        ...
                        <div class="row cart-detail">
                            <div class="col-xs-4">
                                <div class="image"><a href="detail.html"><img
                                            src="{{asset('images/'.$item['productInfo']->image)}}" alt=""></a></div>
                            </div>
                            <div class="col-xs-7">
                                <h3 class="name"><a href="index.php?page-detail">{{$item['productInfo']->name}}</a></h3>
                                <div class="price">${{number_format($item['productInfo']->price)}}
                                    x {{$item['quanty']}}</div>
                            </div>
            ...
            <!-- /.cart-item -->
                ...
                <div class="clearfix cart-total">
                    ...
                    <div class="pull-right">
                        <span class="text">Sub Total :</span><span class='price'>{{number_format(Session::get('Cart')->totalPrice)}} VNĐ</span>
                    </div>
                    @else
                    ...
                    @endif
                    <div class="clearfix"></div>
                    <a href="{{route('shopping.viewCart')}}" class="btn btn-upper btn-primary btn-block m-t-20">Mua
                        hàng</a>
                </div>
                <!-- /.cart-total-->
