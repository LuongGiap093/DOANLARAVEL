...
@section('content')
    ...
    <div class="body-content outer-top-xs">
        <div class="container">
            ...
            <form action="{{route('giamgia')}}" method="POST" class="creditly-card-form agileinfo_form">
                @csrf
                <div class="row" id="list-cart">
                    {{--                    <div class="col-md-4 col-sm-12 estimate-ship-tax">--}}
                    {{--                        <table class="table">--}}
                    ...
                    {{--                                <th>--}}
                    {{--                                    <span class="estimate-title">TÍNH PHÍ VẬN CHUYỂN</span>--}}
                    {{--                                    <p>Nhập điểm đến của bạn để nhận phí vận chuyển.</p>--}}
                    {{--                                </th>--}}
                    {{--                            </tr>--}}
                    {{--                            </thead><!-- /thead -->--}}
                    {{--                            <tbody>--}}
                    ...
                    {{--                                            <option>--Lựa chọn của bạn--</option>--}}
                    ...
                    {{--                                    </div>--}}
                    {{--                                    <div class="form-group">--}}
                    {{--                                        <label class="info-title control-label">Zip/Mã bưu điện</label>--}}
                    {{--                                        <input type="text" class="form-control unicase-form-control text-input"--}}
                    {{--                                               placeholder="">--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="pull-right">--}}
                    {{--                                        <button type="submit" class="btn-upper btn btn-primary">TÍNH PHÍ</button>--}}
                    {{--                                    </div>--}}
                    {{--                                </td>--}}
                    {{--                            </tr>--}}
                    {{--                            </tbody>--}}
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control unicase-form-control text-input"
                                               name="coupon" placeholder="Mã giảm giá của bạn.." value="">
                                    </div>
                                    <div class="clearfix pull-right">
                                        <button type="submit" class="btn-upper btn btn-primary" name="AddCoupon"
                                                value="Tính mã giảm giá">ÁP DỤNG
                                        </button>
                                    </div>
                                </td>
                            </tr>
