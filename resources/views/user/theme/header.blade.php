        ...
        <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row"> 
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              ...
              <div class="basket-item-count"><span class="count">X</span></div>
              ...
              <li>
                ...
                @foreach(Session::get('Cart')->products as $item)
                  <div class="cart-item product-summary">
                    <div class="row cart-detail">
                      ...
                      <div class="col-xs-7">
                        ...
                        <div class="price">{{number_format($item['productInfo']->price)}} x {{$item['quanty']}} VNĐ</div>                     
                      </div>
                  ...
                  <div class="clearfix cart-total">
                    ...
                    <span class="text">Tổng tiền:</span><span class='price'>{{number_format(Session::get('Cart')->totalPrice)}} VNĐ</span> </div>
                    @else
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{route('shopping.index')}}">Trang Chủ</a> </li>
                <li class="dropdown hidden-sm"> <a href="{{route('shopping.category')}}">Danh Mục Sản Phẩm<span class="menu-label new-menu hidden-xs">Mới</span> </a> </li>
